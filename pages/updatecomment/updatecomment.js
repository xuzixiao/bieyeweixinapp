...
Page({
  ...
  onLoad: function (options) {
    ...
    let updatecommentdata=app.globalData.updatecommentdata;
    that.setData({
      OrderID: options.OrderID,
      productid: app.globalData.orderInfor.productid,
      OrderInfor: app.globalData.orderInfor,
      updatecommentdata: updatecommentdata,
      plimgs:updatecommentdata.plimgs,
      wholescore: updatecommentdata.wholescore,
      facscore: updatecommentdata.facscore,
      hyscore: updatecommentdata.hyscore,
      serscore: updatecommentdata.serscore,
  ...
  submitdiscuss: function () {
    ...
    wx.request({
      url: 'https://wxapp.bie-ye.com/api/EditComment',
      method: "PUT",
      data: data,
      header: {
